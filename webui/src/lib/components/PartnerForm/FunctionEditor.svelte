...
<div class="validation_line">
	...
	{:else}
		...
		<Button kind="tertiary" size="small" on:click={editHandler} iconDescription="Add" icon={Add} />
	{/if}
</div>

<FunctionEditorModal bind:open={modalOpen} {functionConfig} on:save={saveChanges} {functionType} />

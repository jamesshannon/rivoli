<script lang="ts">
  ...
  let filetype = partner.fileTypes.find(
    (ft) => ft.id == $page.params.filetypeid
  )!;
...
<Breadcrumb noTrailingSlash>
  ...
  <BreadcrumbItem href="/partners/{partner.id}#filetypes"
    >Filetypes</BreadcrumbItem
  >
  <BreadcrumbItem
    href="/partners/{partner.id}/filetypes/{filetype.id}"
    isCurrentPage>{filetype.name}</BreadcrumbItem
  >
</Breadcrumb>
